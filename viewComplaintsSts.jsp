...
<body class="main-layout">
	...
	<section>
		<div class="container" align="center">
			<h1 style="color: red">View Complaint Status</h1>
			<table class="table">
				<tr>
					<th>Sr.No</th>
			...
			<%
				...
				PreparedStatement pst = con.prepareStatement("SELECT * FROM `complaints_details` where complaint_by='"+email+"'");
				...
				while(rs.next())
				{
					...
					String p_name=gf.getPoliceName(rs.getString("assogn_to"));
				%>
				<tr>
					<th><%=i %></th>

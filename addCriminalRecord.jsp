...
{
	out.print("<script>alert('Criminal Add Successfull..!')</script>");
}
		...
		<div class="container">
			<div class="row">
				...
				<div align="center" class="col-lg-6">
					<font style="font-size: 30px; color: blue;"><u>Add New Criminal Records</u></font>
					<div class="row pdn-top-30"></div>
					<div class="container">
					<form action="AddCriminalRecord" method="POST" name="ureg">
						<table id="example"
							class="table table-striped responsive-utilities jambo_table">
							<tr></tr>
							<tr>
								<td><label for="fname"><b>Criminal Name</b></label></td>
								<td><input type="text" placeholder="Enter Full Name" name="fname" onblur="return AllowAlphabet()" required></td>
								<td><input type="text" placeholder="Enter Last Name" name="lname" onblur="return AllowAlphabet()" required></td>
							</tr>
							<tr>
								<td><label for="c_type"><b>Criminal Type</b></label></td>
								<td><input type="text" placeholder="Enter Criminal "name="c_type" required></td>
							</tr>
							
							
							<tr></tr>
							<tr>
								<td><label for="psw"><b>About Crminial</b></label></td>
								<td><textarea rows="3" cols="30" name="about_criminal" required="required"></textarea></td>
							</tr>
							<tr>
								<td></td>
								<td><input type="submit" value="Add New Criminal Record" style="color: blue;"></td>
							</tr>

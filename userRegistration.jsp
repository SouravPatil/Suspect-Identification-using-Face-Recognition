...
<body class="main-layout">
	...
	{
		out.print("<script>alert('UID or Email Already Exist of Another User..!')</script>");
	}
	...
	<section>
		<div class="container">
			<div class="row">
				...
				<div align="center" class="col-lg-6">
					<font style="font-size: 30px; color: blue;"><u>User Registration</u></font>
					<div class="row pdn-top-30"></div>
					<div class="container">
					<form action="UserRegistration" method="POST" name="ureg">
						<table class="table">
							...
							<tr>
								<td><label for="fname"><b>Last Name</b></label></td>
							...
							<tr>
								...
								<td><input type="number" placeholder="Enter UID Number" onblur="return uidValidate()"
							...
							<tr>
								<td><label for="email"><b>Mobile Number</b></label></td>
								<td><input type="text" placeholder="Enter Mobile Number"
									name="mnumber" onblur="return Validate()" required></td>
							</tr>
							<tr>
								<td><label for="email"><b>Address</b></label></td>
								<td><textarea rows="3" cols="30" name="address" required="required"></textarea></td>
							</tr>
							<tr>
								<td><label for="psw"><b>Password</b></label></td>
								<td><input type="password" placeholder="Enter Password"
									name="password" onblur="return validuaernameandpass()" required></td>
							</tr>
							<tr>
								<td></td>
							...
							<tr>
								<td></td>
								<td style="color: red;">Press Q Butun After Face Detection in Camera</td>
							</tr>
							<tr>
								<td></td>
								<td><a href="userLogin.jsp" style="color: blue;"><u>Already User Login Click Here</u></a></td>
							</tr>

<%@page import="com.javacode.user.GlobalFunction"%>
...
<body class="main-layout">
	...
	<section>
		<div class="container" align="center">
			<h1 style="color: red">View All Criminal Details</h1>
			<table class="table">
				<tr>
					<th>Sr.No</th>
			...
			<%
				...
				PreparedStatement pst = con.prepareStatement("SELECT * FROM `complaints_details` where assogn_to='"+email+"'");
				...
				while(rs.next())
				{
					...
					String fname=gf.getUserName(complaint_by);
					String mobile=gf.getUserMobile(complaint_by);
				...
				<tr>
					...
					<td><%=fname %>&nbsp;(<%=mobile %>)</td>
					<td><img alt="" src="complaints/<%=img_name%>" style="width: 50%;"></td>
					<td><%=rs.getString("complaint_details") %></td>
					<td><%=rs.getString("status") %></td>
						<td><a href="UpdateStatus?id=<%=id%>&sts=Received">Received Request</a></td>
					<td><a href="UpdateStatus?id=<%=id%>&sts=Solve">Solve</a></td>

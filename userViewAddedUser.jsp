	...
	<section>
		<div class="container" align="center">
			...
			<%
					...
					PreparedStatement pst = con.prepareStatement("SELECT * FROM `sub_details` where user_add_by='"+email+"'");
					...
					%>
						...
						<td><%=i %></td>
							...
							<td><%=rs.getString("u_relation") %></td>
							<td><%=rs.getString("user_uid") %></td>
							<td><%=rs.getString("gender") %></td>
							<td><%=rs.getString("p_address") %></td>
							<td><%=rs.getString("c_address") %></td>
							<td><%=rs.getString("refenrnce_name") %></td>
						</tr>					
					<%} %>
			</table>		
		</div>
